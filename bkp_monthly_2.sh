...
#
# =====================================================================
# Filename:             bkp_monthly_2.sh
# ---------------------------------------------------------------------
#
#  Description :        monthly backup of Teradata & Linux
#                              
#  Important Note:
#
#  Date        Name             Reason
...
############################################################################################################
######## This reagister the tapes for Netbackup catalog and DSC jobs #############
############################################################################################################
Trigger_Catalog_Job() {
...
/usr/bin/echo ${Backup_Seq} + 1 | bc > ${SrcDir}/Monthly_Backup_Seq.dat

/bin/rm -f $RunFile  >> $PLog
